...
export const ko = {
  ...
  // ---------- star chart (meta) ----------
  'chart.title': '별자리',
  'chart.subtitle': '죽음은 배움이다. 골드로 별을 이어 귀향의 길을 그려라.',
  'chart.rank': '{0} / {1}',
  'chart.cost': '{0} 골드',

  'chart.boonSlots.name': '신탁의 그릇',
  'chart.boonSlots.desc': '한 항해에서 동시에 받을 수 있는 신의 축복 종류. 지금은 최대 {0}종.',
  'chart.vitality.name': '불굴의 심장',
  'chart.vitality.desc': '시작 최대 체력 +{0}',
  'chart.might.name': '영웅의 피',
  'chart.might.desc': '모든 피해 +{0}%',
  'chart.swift.name': '날랜 발',
  'chart.swift.desc': '이동 속도 +{0}%',
  'chart.fortune.name': '부의 축복',
  'chart.fortune.desc': '획득 골드 +{0}%',
  'chart.wisdom.name': '예언의 지혜',
  'chart.wisdom.desc': '획득 경험치 +{0}%',
  'chart.defiance.name': '저승의 반항',
  'chart.defiance.desc': '항해당 {0}회 부활한다',
  'chart.treasure.name': '보물 감각',
  'chart.treasure.desc': '보물상자 출현 +{0}%, 희귀 카드 확률 상승',
  'chart.headstart.name': '선견지명',
  'chart.headstart.desc': '{0}레벨에서 시작한다',
  ...
  'story.boon.demeter': '"겨울을 빌려주마. 돌려주지 않아도 된다."',
  'story.boon.artemis': '"숨을 멈추고, 한 발만 노려라."',
  'story.boon.dionysus': '"한 잔 들이켜라. 아픈 것쯤은 잊게 해주지."',

  'menu.pantheon': '만신전',
  'pantheon.title': '만신전',
  'pantheon.subtitle': '골드로 신을 모셔라. 모신 신만이 항해 중에 축복을 내린다.',
  'pantheon.unlockFor': '모시기 ◆{0}',
  'pantheon.served': '모시는 중',
  'pantheon.free': '처음부터',
  'pantheon.boons': '축복',
  'pantheon.infusion': '신의 각인',
  'pantheon.unlocked': '{0}을(를) 모셨습니다',
} as const;
